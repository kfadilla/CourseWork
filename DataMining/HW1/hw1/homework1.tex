...
\end{lstlisting}
it produce a plot that list year as x axis, ratio as y axis.
By this plot, it is easily seen 1955-2005's correspondingly. From the data, year 1995 has the highest ratio, while year 2005 has the lowest.
...
\item[]
 \subsection{R script}
\begin{lstlisting}
> dataplot <- barplot(table(myData$V5), xpd = FALSE, ylim = c(0, 1600), xaxt = 'n', xlab = "class", ylab = "count", col = "blue")
